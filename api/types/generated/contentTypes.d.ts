...
export interface ApiProfessionalProfessional
  ...
  attributes: {
    ...
    created_seed_at: Schema.Attribute.DateTime;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    employees: Schema.Attribute.Integer;
    hires: Schema.Attribute.Integer;
    images: Schema.Attribute.Component<'media.image', false>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    years_in_business: Schema.Attribute.Integer;
  };
}
